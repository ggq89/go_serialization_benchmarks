...
func (p *ThriftStruct) GetName() string {
	return p.Name
}



func (p *ThriftStruct) GetBirthDay() int64 {
	return p.BirthDay
}



func (p *ThriftStruct) GetPhone() string {
	return p.Phone
}



func (p *ThriftStruct) GetSiblings() int32 {
	return p.Siblings
}



func (p *ThriftStruct) GetSpouse() bool {
	return p.Spouse
}



func (p *ThriftStruct) GetMoney() float64 {
	return p.Money
}

func (p *ThriftStruct) Read(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *ThriftStruct) ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *ThriftStruct) ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *ThriftStruct) ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(ctx); err != nil {
...
func (p *ThriftStruct) ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *ThriftStruct) ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *ThriftStruct) ReadField6(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *ThriftStruct) Write(ctx context.Context, oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin(ctx, "ThriftStruct"); err != nil {
...
func (p *ThriftStruct) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *ThriftStruct) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *ThriftStruct) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *ThriftStruct) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *ThriftStruct) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *ThriftStruct) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *ThriftStruct) Equals(other *ThriftStruct) bool {
	if p == other {
		return true
...
func (p *ThriftStruct) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ThriftStruct(%+v)", *p)
}

func (p *ThriftStruct) LogValue() slog.Value {
	if p == nil {
		return slog.AnyValue(nil)
	}
	v := thrift.SlogTStructWrapper{
		Type: "*goserbench.ThriftStruct",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*ThriftStruct)(nil)

func (p *ThriftStruct) Validate() error {
	return nil
}
